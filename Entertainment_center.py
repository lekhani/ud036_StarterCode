...
toy_story = media.Movie("Toy Story",
                        "This is a story about a boy and his toys coming to" 
                        "life", 
...
trolls = media.Movie("Trolls",
                     "Poppy and Branch set off on a journey to rescue their"
                     "friends",
                     "https://upload.wikimedia.org/wikipedia/en/a/ad/Trolls"
                     "_%28film%29_logo.png",
...
chennai_express = media.Movie("Chennai Express",
                              "A Man's trip to fulfil his late grandfather's "
                              "wishes",
...
frozen = media.Movie("Frozen",
                     "Princess Anna helps her sister Queen Elsa to control "
                     "her power",
                     "https://upload.wikimedia.org/wikipedia/en/0/05/Frozen"
                     "_%282013_film%29_poster.jpg",
